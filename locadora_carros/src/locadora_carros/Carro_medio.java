...
/**
 * @author Bruno
 * Regra de Preço Final: arros médios, o valor base é reduzido em 5% para 
 * cada ano de idade do modelo, limitado a um desconto de 15% 
 */
public class Carro_medio extends Carro {
  GregorianCalendar gc = new GregorianCalendar();
    
    //private double valor_final;

    public Carro_medio(String placa, int modelo, double valor_base, int ano, int codCad) {
